...
const projects = [
  {
    ...
    name: "PlacementOS",
    category: "Full-Stack",
    description: "An AI-powered career command center. PlacementOS analyzes your code, portfolio, and market trends to orchestrate your placement journey and help you land the right opportunities faster.",
    tech: ["React", "FastAPI", "Python", "TailwindCSS", "Vite"],
    github: "https://github.com/vansh070605/PlacementOS.git",
    live: "https://placementosai.vercel.app/",
    accent: "#6366F1",
    emoji: "🚀",
  },
  {
  ...
  },
  {
    ...
    name: "ClariMed",
    category: "AI/ML",
    description: "An Explainable Healthcare Copilot designed to help patients understand complex medical reports through advanced artificial intelligence, securely and accurately.",
    tech: ["Next.js", "FastAPI", "Gemini API", "Qdrant (RAG)", "PostgreSQL"],
    github: "https://github.com/vansh070605/ClariMed.git",
    live: "https://clarimed-ai.vercel.app/dashboard",
    accent: "#E11D48",
    emoji: "🩺",
  },
  {
    ...
    name: "WakeGuard",
    category: "AI/ML",
    description: "An AI-powered driver monitoring system that detects drowsiness and yawning in real time using Computer Vision.",
    tech: ["React", "MediaPipe", "TailwindCSS", "Recharts"],
    github: "https://github.com/vansh070605/WakeGuard.git",
    live: "https://wake-guard.vercel.app/",
    accent: "#D97706",
    emoji: "👁️",
  },
  {
    ...
    name: "MealSync",
    category: "Full-Stack",
    description: "A full-stack app for 6 flatmates to fairly choose dinner, featuring smart dietary/preference filters and a mobile-first UI.",
    tech: ["FastAPI", "Python", "React", "Scikit-Learn", "XGBoost"],
    github: "https://github.com/vansh070605/MealSync.git",
    live: "https://meal-sync-flat.vercel.app/",
    accent: "#10B981",
    emoji: "🍽️",
  },
  {
    ...
    name: "GlucoSense",
    category: "AI/ML",
    description: "A Modern AI-Powered Diabetes Risk Assessment System that combines clinical precision with a premium user experience.",
    tech: ["Python", "Django", "Scikit-Learn", "SQLite", "TailwindCSS"],
    github: "https://github.com/vansh070605/GlucoSense.git",
    live: "https://gluco-sense.vercel.app/",
    accent: "#8B5CF6",
    emoji: "🩸",
  },
];
